...
CUSTOM_TEXT = (
    str(PMPERMIT_TEXT)
    if PMPERMIT_TEXT
    else f"__Halo kawan, saya bot yang menjaga room chat shin-userbot {DEFAULTUSER} di mohon jangan melakukan spam , kalau anda melakukan itu OTOMATIS saya akan memblockir anda!__ \n"
)
DEF_UNAPPROVED_MSG = (
    "╔═════════════════════╗\n"
    "    💥 𝗛𝗔𝗧𝗜 𝗛𝗔𝗧𝗜 𝗬𝗚𝗬 💥 \n"
