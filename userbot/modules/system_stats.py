...
async def bot_ver(event):
    ...
    if which("git") is not None:
        ...
        await event.edit(
            "**⚜-**💥 shin-userbot 💥 Versi:** \n "
            f"heads/shin-userbot-0-x634i7u1"
            "\n**⚜-**Revisi:**\n "
            f"{revout}"
        )
    else:
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━━━━━━━━━━✠╯\n"
        f"[ɢʀᴏᴜᴘꜱ](https://t.me/shinsuport) | [ʙᴏᴛᴏꜰ](https://t.me/{user.username}) | [ɢɪᴛʜᴜʙ](https://github.com/serwalker/shin-userbot)"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
@register(outgoing=True, pattern=r"^\.(?:shinzuon)\s?(.)?")
async def amireallyalive(alive):
    await bot.get_me()
    await get_readable_time((time.time() - StartTime))
    output = (
        f"●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬● \n"
        f"✾ 🤴 • `ᴏᴡɴᴇʀ :`[ᴛᴜᴀɴ sʜɪɴ](t.me/Shinzuonnnn)             ㅤ \n"
...
async def redis(alive):
    ...
    output = (
        ...
        f"┃✧ Owner    : [Shin](https://t.me/Shinzuonnnn) \n"
