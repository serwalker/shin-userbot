...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/serwalker/shin-userbot"
)
UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "shin-userbot")
...
# Untuk Perintah .shinalive
SHIN_TEKS_KUSTOM = os.environ.get("SHIN_TEKS_KUSTOM", "")
...
# Bot Name
TERM_ALIAS = os.environ.get("TERM_ALIAS", "shin-userbot")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://telegra.ph/file/2fc2de8309c342416c670.jpg")
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:
                ...
                await event.edit(
                    ...
                    link_preview=True,
                    buttons=[
                        [Button.url("ᴄʜᴀɴɴᴇʟ", "t.me/aboutmegashine")],
                    ],
                )
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(""):
                ...
                result = builder.article(
                    "Bantuan Dari **💥shin-userbot💥**",
                    text="Daftar Plugins",
                    buttons=[],
                    link_preview=True,
                )
            else:
                result = builder.article(" **💥𝐒𝐇𝐈𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓​💥**",
                                         text="""°𝐒𝐇𝐈𝐍-𝐔𝐒𝐄𝐑𝐁𝐎𝐓°""",
                                         buttons=[[custom.Button.url("sᴋʏᴢᴜ​",
                                                                     "https://github.com/serwalker/shin-userbot"),
                                                   custom.Button.url("ᴄʜᴀɴɴᴇʟ​",
                                                                     "t.me/aboutmegashine"),
                                                   ],
                                                  [custom.Button.url("ʟɪᴄᴇɴsᴇ​",
                                                                     "https://github.com/serwalker/shin-userbot/LICENSE",
                                                                     )],
                                                  ],
                                         link_preview=False,
                                         )
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # userbot
                ...
                await event.edit(
                    ...
                    buttons=[
                        [
                            Button.url("❈ꜱᴜᴘᴘᴏʀᴛ❈", "t.me/shinsuport"),
                            Button.url("❈ᴄʜᴀɴɴᴇʟ❈", "t.me/aboutmegashine"),
                        ],
                        [custom.Button.inline(
